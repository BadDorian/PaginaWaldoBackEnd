...
namespace WebApiTestv2.Migrations
{
    ...
    [Migration("20241106025925_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiPW.Models.Carrito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApiPW.Models.CarritoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApiPW.Models.CarritoItem", b =>
                {
                    b.HasOne("WebApiPW.Models.Carrito", "Carrito")
                        .WithMany()
                        .HasForeignKey("CarritoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApiTestv2.Models.Producto", "Producto")
                        .WithMany()
